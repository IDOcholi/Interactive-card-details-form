...
const frontDateMonth = document.getElementById("expmonth");
const frontDateYear = document.getElementById("expyear");
const backCardCvc = document.getElementById("backnumber");
...
const thankYouBtn = document.getElementById("backbtn");
